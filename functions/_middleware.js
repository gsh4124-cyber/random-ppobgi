export async function onRequest(context) {
  ...
  const titles={ko:'랜덤뽑기 | 8가지 뽑기 게임',en:'Random Picker | 8 Picker Games',ja:'ランダム抽選 | 8つの抽選ゲーム',es:'Selector aleatorio | 8 juegos de sorteo',zh:'随机抽选 | 8种抽选游戏',fr:'Sélecteur aléatoire | 8 jeux de tirage',de:'Zufallsauswahl | 8 Auswahlspiele',pt:'Sorteador aleatório | 8 jogos de sorteio',id:'Pemilih Acak | 8 Game Undian',hi:'रैंडम पिकर | 8 पिकर गेम',pl:'Losowy wybór | 8 gier losujących',it:'Selettore casuale | 8 giochi di estrazione',nl:'Willekeurige kiezer | 8 trekspellen',tr:'Rastgele Seçici | 8 seçim oyunu',vi:'Bộ chọn ngẫu nhiên | 8 trò chơi chọn',th:'สุ่มเลือก | 8 เกมสุ่ม',ar:'اختيار عشوائي | 8 ألعاب اختيار'};
